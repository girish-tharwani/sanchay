...
public class PersistenceService {
    ...
    public static void seedDefaultCategories(DataStore store) {
        String[][] expenseDefs = {
                ...
                {"Bills",
                        "Cell Phone", "Electricity", "Health Club", "Internet Service",
                        "LPG/PNG", "Newspaper", "Society Maintenance", "Telephone"},
                {"Education",
                ...
                {"Hobbies/Leisure",
                        "Books/Magazines", "Hobby Classes", "OTT Subscriptions",
                ...
                {"Lifestyle",
                        "Clothing", "Cosmetics", "Gadgets", "Personal Care/Salon", "Wellness/Spa"},
                {"Miscellaneous",
                ...
                {"Travel/Vacation",
                        "Food", "Hotels", "Miscellaneous", "Tickets"},
        };
